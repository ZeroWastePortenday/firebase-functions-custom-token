...
function requestMe(kakaoAccessToken) {
    ...
    return request({
        method: 'GET', headers: {'Authorization': 'Bearer ' + kakaoAccessToken}, url: kakaoRequestMeUrl,
    })
}
...
function updateOrCreateUser(userId, email, displayName, photoURL) {
    ...
    const updateParams = {
        provider: 'KAKAO', displayName: displayName,
    };
    if (displayName) {
 ...
 */
module.exports = function createKakaoFirebaseToken(kakaoAccessToken) {
